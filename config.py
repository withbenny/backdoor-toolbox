...
trigger_default = {
    ...
    "tinyimagenet": {
        ...
        "adaptive_patch": "none",
        "adaptive_k_way": "none",
        "clean_label": "badnet_patch4_dup_64.png",
        "basic": "badnet_patch_64.png",
        ...
        "ISSBA": "none",
        "SleeperAgent": "none",
        "badnet_all_to_all": "badnet_patch_64.png",
        "trojannn": "none",
        "BadEncoder": "none",
        "SRA": "phoenix_corner_64.png",
        "trojan": "trojan_square_64.png",
        "bpp": "none",
        "WB": "none",
    },
    "stl10": {
...
def get_dataset(inspection_set_dir, data_transform, args, num_classes=10):
    ...
    inspection_set = tools.IMG_Dataset(
        data_dir=inspection_set_img_dir,
        label_path=inspection_set_label_path,
