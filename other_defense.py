...
parser.add_argument(
    "-defense", type=str, required=True, choices=default_args.parser_choices["defense"]
)
...
if args.defense == "NC":
    ...
    defense = NAD(args, teacher_epochs=10, erase_epochs=20)
    defense.detect()
    ...
    # if args.dataset == 'cifar10':
    defense = NONE(
        args, none_lr=1e-2, max_reset_fraction=0.03, epoch_num_1=200, epoch_num_2=40
    )
    defense.detect()
