...
class ResNet(nn.Module):
    ...
    def register_all_hooks(self):
        self.conv1.register_forward_hook(
            self.make_hook("Conv1_Conv1_Conv1_", "forward")
        )
        self.layer1[0].conv1.register_forward_hook(
            self.make_hook("Layer1_0_Conv1_", "forward")
        )
        self.layer1[0].conv2.register_forward_hook(
            self.make_hook("Layer1_0_Conv2_", "forward")
        )
        self.layer1[1].conv1.register_forward_hook(
            self.make_hook("Layer1_1_Conv1_", "forward")
        )
        self.layer1[1].conv2.register_forward_hook(
            self.make_hook("Layer1_1_Conv2_", "forward")
        )

        self.layer2[0].conv1.register_forward_hook(
            self.make_hook("Layer2_0_Conv1_", "forward")
        )
        self.layer2[0].downsample.register_forward_hook(
            self.make_hook("Layer2_0_Downsample_", "forward")
        )
        self.layer2[0].conv2.register_forward_hook(
            self.make_hook("Layer2_0_Conv2_", "forward")
        )
        self.layer2[1].conv1.register_forward_hook(
            self.make_hook("Layer2_1_Conv1_", "forward")
        )
        self.layer2[1].conv2.register_forward_hook(
            self.make_hook("Layer2_1_Conv2_", "forward")
        )

        self.layer3[0].conv1.register_forward_hook(
            self.make_hook("Layer3_0_Conv1_", "forward")
        )
        self.layer3[0].downsample.register_forward_hook(
            self.make_hook("Layer3_0_Downsample_", "forward")
        )
        self.layer3[0].conv2.register_forward_hook(
            self.make_hook("Layer3_0_Conv2_", "forward")
        )
        self.layer3[1].conv1.register_forward_hook(
            self.make_hook("Layer3_1_Conv1_", "forward")
        )
        self.layer3[1].conv2.register_forward_hook(
            self.make_hook("Layer3_1_Conv2_", "forward")
        )

        self.layer4[0].conv1.register_forward_hook(
            self.make_hook("Layer4_0_Conv1_", "forward")
        )
        self.layer4[0].downsample.register_forward_hook(
            self.make_hook("Layer4_0_Downsample_", "forward")
        )
        self.layer4[0].conv2.register_forward_hook(
            self.make_hook("Layer4_0_Conv2_", "forward")
        )
        self.layer4[1].conv1.register_forward_hook(
            self.make_hook("Layer4_1_Conv1_", "forward")
        )
        self.layer4[1].conv2.register_forward_hook(
            self.make_hook("Layer4_1_Conv2_", "forward")
        )
