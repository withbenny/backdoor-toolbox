...
def generate_dataloader(
    ...
    if dataset == "cifar10":
        ...
        if noisy_test:
            ...
            noisy_test_set_dir = os.path.join(
                "clean_set", "cifar10", "noisy_test_split"
            )
            ...
            noisy_test_set = IMG_Dataset(
                data_dir=noisy_test_set_img_dir,
                label_path=noisy_test_set_label_path,
        ...
        if split == "train":
            train_data = datasets.ImageFolder(
                os.path.join(os.path.join(dataset_path, "imagenette2"), "train"),
                data_transform,
            )
            train_data_loader = DataLoader(
                dataset=train_data,
            ...
            test_data = datasets.ImageFolder(
                os.path.join(os.path.join(dataset_path, "imagenette2"), "val"),
                data_transform,
            )
            test_data_loader = DataLoader(
                dataset=test_data,
        ...
        if split == "train":
            train_data = imagenet.imagenet_dataset(
            ...
            test_data = imagenet.imagenet_dataset(
            ...
            val_split_indices = torch.load(
                os.path.join(val_split_meta_dir, "clean_split_indices")
            )
